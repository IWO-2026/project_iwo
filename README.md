...
Twórca gier jest użytkownikiem systemu odpowiedzialnym za projektowanie scenariuszy rozgrywek LARP. Korzysta z systemu w celu definiowania struktury gry, w tym map, postaci, zadań oraz mechanik rozgrywki. Twórca gier może również edytować istniejące scenariusze oraz zgłaszać je do weryfikacji przed publikacją. System powinien umożliwiać intuicyjne tworzenie i zarządzanie elementami świata gry.
...
Recenzent jest użytkownikiem systemu odpowiedzialnym za ocenę i weryfikację zgłoszonych scenariuszy gier LARP. Korzysta z systemu w celu przeglądania listy zgłoszonych gier, analizowania ich poprawności oraz przekazywania opinii twórcom. Recenzent może zatwierdzać lub odrzucać scenariusze przed ich publikacją. System powinien zapewniać narzędzia umożliwiające sprawną komunikację z twórcami oraz dostęp do szczegółowych informacji o grach.
...
Pracownik platformy jest użytkownikiem systemu odpowiedzialnym za nadzorowanie procesu publikacji wydarzeń oraz ich wyceny. Korzysta z systemu w celu zatwierdzania ostatecznej ceny wydarzenia, analizy kosztów organizacji oraz weryfikacji poprawności zgłoszeń. System powinien umożliwiać przegląd szczegółowych danych dotyczących wydarzeń oraz wspierać proces podejmowania decyzji biznesowych.
...
System płatności jest zewnętrznym systemem współpracującym z platformą, odpowiedzialnym za obsługę transakcji finansowych. Umożliwia użytkownikom dokonywanie płatności za udział w wydarzeniach oraz realizację zwrotów środków w przypadku anulowania wydarzenia. System powinien zapewniać bezpieczne i szybkie przetwarzanie płatności oraz przekazywać informacje o statusie transakcji do platformy.

System zewnętrzny / urządzenia
...
System zewnętrzny obejmuje urządzenia fizyczne oraz komponenty techniczne wykorzystywane podczas wydarzeń LARP, takie jak kody QR czy czujniki. System współpracuje z platformą w celu umożliwienia interakcji graczy z elementami świata gry. Po wykryciu interakcji (np. zeskanowaniu kodu QR) system przekazuje odpowiednie informacje do aplikacji, inicjując zdarzenia w grze.
---
